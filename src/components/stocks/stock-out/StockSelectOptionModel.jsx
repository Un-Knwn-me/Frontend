...
const StockSelectOptionModel = ({ show, onClose }) => {
                        ...
                        <div className="py-2 flex flex-col justify-between h-full">
                            ...
                            <div className="flex flex-col py-5 items-center flex-grow">
                                <div className="text-center">
                                    <button className="bg-sky-600 w-64 py-3 text-white rounded-lg font-bold text-md mt-4" onClick={handleEnterManually}>
                                        With Purchase Order
                                    </button>
                                </div>
                                <div className="text-center">
