...
const LengthAddModal = ({
  isModalOpen,
  onClose,
  fetchAllLengths,
  fetchLengthSuggestions,
  setLengthDropdown,
}) => {
  ...
  const handleSingleLength = async () => {
    try {
      ...
      if (response.status === 201) {
        ...
        fetchLengthSuggestions(singleLength)
      ...
      <div className="py-2 flex flex-col">
        <div>
          <div className="flex justify-center">
            <h2 className="text-2xl font-bold">Add Length</h2>
            <button
        ...
        <div className="flex flex-col items-center">
          {/* <p className="text-gray-400 font-bold mt-10">*For multiple “Length” feed use enter after each values</p> */}
          <input
