...
const FabricFinishAddModal = ({
  isModalOpen,
  onClose,
  fetchAllfabricFinishes,
  fetchFabricFinishSuggestions,
  setFabricFinishDropdown
}) => {
  ...
  const handleSingleFabricFinish = async () => {
    try {
      ...
      if (response.status === 201) {
        ...
        fetchFabricFinishSuggestions(singleFabricFinishes)
...
export default FabricFinishAddModal;
