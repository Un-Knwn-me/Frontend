...
const PackingMethodAddModal = ({
  isModalOpen,
  onClose,
  fetchAllPacking,
  fetchPackingMethodSuggestions,
  setPackingDropdown,
}) => {
  ...
  const handleSinglePacking = async () => {
    try {
      ...
      if (response.status === 201) {
        ...
        fetchPackingMethodSuggestions(singlePacking)
...
export default PackingMethodAddModal;
