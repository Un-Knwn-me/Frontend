...
const ProductTypesAddModal = ({
  isModalOpen,
  onClose,
  fetchAllProductTypes,
  setProductTypesDropdown,
  fetchProductTypesSuggestions
}) => {
  ...
  const handleSingleProductType = async () => {
    try {
      ...
      if (response.status === 201) {
        ...
        fetchProductTypesSuggestions(singleProductType)
...
export default ProductTypesAddModal;
