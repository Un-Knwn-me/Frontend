...
const Length = ({ searchQuery, isModalOpen, onClose }) => {
 ...
 const handleSaveClick = async (index, id) => {
  ...
  const filteredData = data.filter(
    (item) =>
      item.lengthType &&
      item.lengthType.toLowerCase().includes(searchQuery.toLowerCase())
  );
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-[35vw] h-fit overflow-y-auto lg:overflow-hidden">
            <div className="flex flex-col py-5">
              ...
              <div className="flex flex-col items-center">
                {/* <p className="mt-10 font-bold text-gray-400">*For multiple “Length” feed use enter after each values</p> */}
                <input
